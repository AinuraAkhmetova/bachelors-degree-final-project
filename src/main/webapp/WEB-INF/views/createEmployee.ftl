...
<div id="header-featured">
    <div id="banner-wrapper">
        <div id="banner" class="container">
            <h2>Добавление сотрудника предприятия</h2>
        </div>
    </div>
</div>
<div id="wrapper">
    <div id="featured-wrapper">
        <div id="featured" class="extra2 margin-btm container">
            <div class="main-title">
                ...
                <form name="employee" action="/addEmployee" method="post" id="customers">
                    <p>Фамилия Имя</p>
                    <input title="Name" type="text" name="name" size="40">
                    <br>
                    <p>Адрес эл. почты</p>
                    <input title="Email" type="text" name="email" size="40">
                    <br>
                    <p>Должность</p>
                    <input title="Position" type="text" name="position" size="40">
                    <br>
                    <p>Возраст</p>
                    <input title="Age" type="text" name="age" size="10">
