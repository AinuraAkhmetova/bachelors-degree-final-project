...
function placeBoxes(boxes, chartArea, params) {
	var employeePadding = params.padding;
	var x = chartArea.x;
	var y = chartArea.y;
	...
	for (i = 0, ilen = boxes.length; i < ilen; ++i) {
		...
		if (layout.horizontal) {
			box.left = box.fullWidth ? employeePadding.left : chartArea.left;
			box.right = box.fullWidth ? params.outerWidth - employeePadding.right : chartArea.left + chartArea.w;
			box.top = y;
...
var Scale = core_element.extend({
	...
	*/
	...
	convertTicksToLabels: function() {
		...
		var tickOpts = me.options.ticks;
		me.ticks = me.ticks.map(tickOpts.employeeCallback || tickOpts.callback, this);
	},
...
function fitWithPointLabels(scale) {
	...
	//
	// Reaction: https://dl.dropboxemployeecontent.com/u/34601363/toomuchscience.gif
	//
	// Solution:
	//
	...
	//
	// https://dl.dropboxemployeecontent.com/u/34601363/yeahscience.gif
...
var scale_time = core_scale.extend({
	...
	tickFormatFunction: function(time, index, ticks, format) {
		...
		var formatter = resolve$5([
			...
			nestedTickOpts.employeeCallback,
			tickOpts.callback,
			tickOpts.employeeCallback
		]);
